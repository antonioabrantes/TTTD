...
public class KindN extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kind_n);

        listView=(ListView)findViewById(R.id.listViewKindN);
        toolbar = (Toolbar) findViewById(R.id.toolbarKindN);
        ...
        adapter = new ArrayAdapter(KindN.this, android.R.layout.simple_list_item_1,mensagens);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(AdapterView<?> av, View v, int pos, long id)
            {
                ...
                //    Toast.makeText(KindN.this, "Não há dados de temporalidade", Toast.LENGTH_LONG).show();
                ...
                //else {
                 ...
                 //   }
                    //Toast.makeText(KindN.this, texto, Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(KindN.this, Temporal.class);
