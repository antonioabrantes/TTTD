...
public class GPesquisaEquiv2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gpesquisa_equiv2);
        toolbar = (Toolbar) findViewById(R.id.toolbarEquiv2);
        ...
        listView=(ListView)findViewById(R.id.listViewEquiv2);
        mensagens = new ArrayList<String>();
        adapter = new ArrayAdapter(GPesquisaEquiv2.this, android.R.layout.simple_list_item_1,mensagens);
        ...
        try{
            ...
            for (int i = 0; i < counter; i++) {
                ...
                if (item.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    if (symbol2.equals(grupo)) {
                        array_classes[pos]=symbol1;
                        array_mensagem[pos]=assunto1;
                        mensagens.add(symbol1+" "+assunto1);
                        pos = pos + 1;
