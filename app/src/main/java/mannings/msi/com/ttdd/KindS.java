...
public class KindS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kind_s);

        listView=(ListView)findViewById(R.id.listViewKindS);
        toolbar = (Toolbar) findViewById(R.id.toolbarKindS);
        ...
        adapter = new ArrayAdapter(KindS.this, android.R.layout.simple_list_item_1,mensagens);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position==0){
                    ...
                    if (array_proximo[position]==0) {
                        ...
                        Intent intent = new Intent(KindS.this, KindG.class);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(AdapterView<?> av, View v, int pos, long id)
            {
                ...
                //        array_observacoes[pos].equals(" ")){
                 ...
                 //   Toast.makeText(KindS.this, "Não há dados de temporalidade", Toast.LENGTH_LONG).show();
                ...
                //                "Fase intermediária: " + array_fase_intermediaria[pos] + "\n" +
                 ...
                 //               "Observações: " + array_observacoes[pos];
                  //  }
                    //Toast.makeText(KindS.this, texto, Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(KindS.this, Temporal.class);
