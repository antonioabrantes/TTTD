...
public class KindZ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kind_z);

        listView=(ListView)findViewById(R.id.listViewKindZ);
        toolbar = (Toolbar) findViewById(R.id.toolbarKindZ);
        ...
        adapter = new ArrayAdapter(KindZ.this, android.R.layout.simple_list_item_1,mensagens);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position==0){
                    ...
                    if (array_proximo[position]==0) {
                        ...
                        Intent intent = new Intent(KindZ.this, KindM.class);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(AdapterView<?> av, View v, int pos, long id)
            {
                ...
                //    Toast.makeText(KindZ.this, "Não há dados de temporalidade", Toast.LENGTH_LONG).show();
                ...
                //                "Fase intermediária: " + array_fase_intermediaria[pos] + "\n" +
                 ...
                 //   }
                    //Toast.makeText(KindZ.this, texto, Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(KindZ.this, Temporal.class);
