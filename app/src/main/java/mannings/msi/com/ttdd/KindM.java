...
public class KindM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kind_m);

        listView=(ListView)findViewById(R.id.listViewKindM);
        toolbar = (Toolbar) findViewById(R.id.toolbarKindM);
        ...
        adapter = new ArrayAdapter(KindM.this, android.R.layout.simple_list_item_1,mensagens);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position==0){
                    ...
                    if (array_proximo[position]==0) {
                        ...
                        Intent intent = new Intent(KindM.this, KindN.class);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener(){
            ...
            public boolean onItemLongClick(AdapterView<?> av, View v, int pos, long id)
            {
                ...
                //    Toast.makeText(KindM.this, "Não há dados de temporalidade", Toast.LENGTH_LONG).show();
                ...
                ///    }
                    //Toast.makeText(KindM.this, texto, Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(KindM.this, Temporal.class);
