...
public class RegistroAdapter2 extends ArrayAdapter<RegistroOnos2> {

    private ArrayList<RegistroOnos2> registros;
    private Context context;

    public RegistroAdapter2(Context c, ArrayList<RegistroOnos2> objects) {
        super(c, 0, objects);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if( registros != null ){
            ...
            view = inflater.inflate(R.layout.lista_registro2, parent, false);

            // recupera elemento para exibição
            TextView tvAssunto = (TextView) view.findViewById(R.id.tv_assunto2);
            TextView tvSubAssunto = (TextView) view.findViewById(R.id.tv_subAssunto2);
            ...
            RegistroOnos2 registro = registros.get( position );
