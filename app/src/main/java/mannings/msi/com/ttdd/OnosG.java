...
import mannings.msi.com.ttdd.adapter.RegistroAdapter1;
...
public class OnosG extends AppCompatActivity {
    ...
    private ArrayAdapter<RegistroOnos1> adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_onos_g);

        listView=(ListView)findViewById(R.id.listViewOnosG);
        toolbar = (Toolbar) findViewById(R.id.toolbarOnosG);
        ...
        registros.clear();
        adapter = new RegistroAdapter1(OnosG.this, registros );
        listView.setAdapter( adapter );
        ...
        try{
            ...
            count_proximo=1;
            RegistroOnos1 registro0 = new RegistroOnos1();
            ...
            for (int i = 0; i < counter; i++) {
                ...
                if (item.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    if (indice==proxima_tela) {
                        ...
                        int width = size.x;
                        int height = size.y;
                        Resources r = OnosG.this.getResources();
                        ...
                        RegistroOnos1 registro1 = new RegistroOnos1();
                ...
                if (position==0){
                    ...
                    if (grupo.equals(" ")) {
                        if (array_proximo[position] == 0) {
                            ...
                            Intent intent = new Intent(OnosG.this, OnosZ.class);
                    ...
                    {
                        Intent intent = new Intent(OnosG.this, GruposPesquisa.class);
